    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="<?= base_url('assets/img/Logo_Kahatex.png') ?>" width="40px" height="70px" alt="">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?= base_url('/gudang/inputnomodel') ?>">
                            <i class="bi bi-circle"></i><span>Input No Model</span>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <i class="bi bi-circle"></i><span>Input Area</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="">
                            <i class="bi bi-circle"></i><span>Barang Jalan</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Forms Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-layout-text-window-reverse"></i><span>Data Permintaan</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-bar-chart"></i><span>Data Terkirim</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
            ...
            <li class="nav-item">
                ...
                <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="">
                            <i class="bi bi-circle"></i><span>Print Pemasukkan</span>
                        </a>
                    </li>
                    <li>
                        <a href="">
                            <i class="bi bi-circle"></i><span>Print Pengeluaran</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Icons Nav -->
